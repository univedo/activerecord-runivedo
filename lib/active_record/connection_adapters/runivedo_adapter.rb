...
module ActiveRecord
  module ConnectionHandling # :nodoc:
    def runivedo_connection(config)
      ...
      conn = Runivedo::Connection.new(config)
      perspective = db.get_perspective(config[:app])
  ...
  module ConnectionAdapters #:nodoc:
    ...
    class RunivedoAdapter < AbstractAdapter
      ...
      protected
        ...
        def sqlite_version
          @sqlite_version ||= RunivedoAdapter::Version.new(select_value('select sqlite_version(*)'))
        end
